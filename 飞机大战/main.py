...
pygame.display.set_caption("飞机大战---Kang(2020/11/29)")
...
#载入游戏相关图片
background = pygame.image.load("images/background.png").convert()       #返回一个Surface对象，一般需要调用Suface对象的convert方法进行格式转换。
...
def main():
    ...
    while running:
        ...
        screen.blit(background,(0,0))       #将（blit，位块传输）图片Surface画到窗口Surface上Surface对象的blit方法，可以将一个Surface对象画到令一个Surface对象上
